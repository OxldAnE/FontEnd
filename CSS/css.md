...
想要让 `p`元素底边与父元素贴合；添加样式，`p`子元素使得父元素一起塌陷
...
为子元素添加浮动属性后，会影响父元素的布局；因此，需要即时清除浮动的影响；接下来，通过不同的方式清除浮动
...
![image-20220802150910507](assets/image-20220802150910507.png)
...
![image-20220802151003430](assets/image-20220802151003430.png)
...
![image-20220802151747608](assets/image-20220802151747608.png)
...
通过布局实现主体内容按左、主、右排列，左、右固定宽度，主自适应
